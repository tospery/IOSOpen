	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		...
		switch identifier {
			...
			case "edit-interface-type-match":
				...
				enumController.setValues(stringValues.map { String($0) }, title: "Interface Type", currentSelection: currentSelection) { newRow in
			...
			case "edit-on-demand-action":
				...
				enumController.setValues(stringValues.map { String($0) }, title: "Action", currentSelection: currentSelection) { newRow in
