...
struct Config {
    ...
    static let appGroup = "group.com.tospery.ivpn"
    ...
    static let openvpnTunnelProvider = "com.tospery.ivpn.openvpn-tunnel-provider"
    static let openvpnTunnelTitle = "IVPN OpenVPN"
    static let wireguardTunnelProvider = "com.tospery.ivpn.wireguard-tunnel-provider"
