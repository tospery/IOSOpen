...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    override func startTunnel(options: [String : NSObject]?, completionHandler: @escaping (Error?) -> Void) {
        ...
        let networkSettings = NEPacketTunnelNetworkSettings.init(tunnelRemoteAddress: "127.0.0.1")
        
        let ipv4Settings = NEIPv4Settings.init(addresses: ["10.0.0.2"], subnetMasks: ["255.255.255.0"])
